...
class _NavigationScreenState extends State<NavigationScreen> {
  @override
  void initState() {
    BookingCubit.get(context).initialFunction(context: context);
  }
  @override
        ...
        appBar: AppBar(
            ...
            leading: Builder(
              builder: (context) => InkWell(
                ...
                onTap: (){
                  if(bCubit.classInProgress.contains(true)!=false)
                  {
                  ...
                  else if(bCubit.classInDeleting.contains(true)!=false)
                  {
                      ...
                      if(bCubit.selectedDay.isAfter(DateTime.now())||true) {
                      ...
                      } else
                        {
                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(duration: Duration(seconds: 2),
                              content: Text('sorry but you can not add class before current date')
